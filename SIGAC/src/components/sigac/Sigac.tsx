      ...
      <main>
        ...
        <section id="inicio" className="hero">
          <div className="container hero-grid">
            <div className="hero-copy">
              <span className="tag">
                <Landmark size={14} /> Gestão ambiental compartilhada
              </span>
              <h1>
              ...
              <p className="hero-lead">
                O SIGAC organiza a triagem, os documentos e a comunicação em tempo real
                entre o requerente e a secretaria — com suporte à fiscalização, registro
                de multas e funcionamento em conjunto do consórcio.
              </p>
              <div className="hero-actions">
                <Button>Solicitar demonstração</Button>
                <a className="text-link" href="#sobre">
                  Conhecer o SIGAC <ChevronDown size={16} />
                </a>
              </div>
              <p className="hero-proof">
                <CheckCircle2 size={16} /> Integrado ao GeoBahia, MapBiomas e SIRGAS 2000
              </p>
            </div>
        ...
        <section id="desafios" className="section features">
          <div className="container">
            <div className="section-title">
              ...
              <p>
                A gestão ambiental pública esbarrava em processos dispersos, falta de
                indicadores e burocracia em papel. O SIGAC nasceu para resolver isso.
              </p>
            </div>
          ...
          <div className="container about-grid">
            <div>
              ...
              <p className="body-copy">
                O SIGAC acompanha todo o processo de licenciamento ambiental, desde a
                solicitação realizada pelo cidadão até a emissão da licença. A plataforma
                permite a triagem das solicitações, a organização dos dados e documentos
                necessários e a comunicação, em tempo real, entre o requerente e a
                secretaria.
              </p>
              <p className="body-copy">
                O sistema também auxilia nas atividades de fiscalização e no registro de
                eventuais multas, garantindo rastreabilidade de ponta a ponta.
              </p>
              <div className="module-pills">
                {["Triagem", "Licenciamento", "Fiscalização", "Multas", "Comunicação"].map(
                  (item) => (
                    <span key={item}>
            ...
            <div className="card">
              ...
              <p>
                Requerente e secretaria compartilham o mesmo painel: status, pendências,
                documentos e prazos, em tempo real.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="vantagens" className="section features">
          <div className="container">
            <div className="section-title">
              ...
              <p>
                Um conjunto de recursos pensado para a rotina real de secretarias e
        ...
        <section id="recursos" className="section">
          <div className="container">
            <div className="section-title">
              ...
              <p>
                Sem instalação, sem servidor local. Tudo o que a equipe precisa, na
                nuvem.
              </p>
            </div>
            <div className="feature-grid">
        ...
        <section className="section features">
          <div className="container about-grid">
            <div>
              ...
              <p className="body-copy">
                Para facilitar a comunicação, o sistema conta com notificação em tempo
                real, que informa aos requerentes o andamento do seu processo, agilizando
                os trâmites para que não se percam prazos.
              </p>
              <p className="body-copy">
                A <strong>IAra</strong> é um agente de inteligência artificial do SIGAC
                com qualificação técnica para orientar a população pelo WhatsApp sobre os
                requerimentos.
              </p>
              <div className="module-pills">
                {["Notificação em tempo real", "Andamento do processo", "IAra — IA técnica"].map(
                  (item) => (
                    <span key={item}>
                      <CheckCircle2 size={14} />
                      {item}
            ...
            <div className="card">
              ...
              <p>
                Orientação técnica para o cidadão, resposta rápida para a secretaria e
                menos idas e vindas no atendimento.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section modules">
          <div className="container">
            <div className="section-title">
              ...
              <p>
                Muitas vezes, os técnicos atuam em áreas que não têm sinal de internet.
                Por isso, o SIGAC conta com um app mobile com suporte offline para
                facilitar as vistorias e fiscalizações.
              </p>
            </div>
            <div className="module-grid">
              <div>
                ...
                <p>
                  Registre fiscalizações, fotos e observações mesmo em áreas remotas.
                  Os dados sincronizam quando a conexão voltar.
                </p>
              </div>
              <div>
                <Smartphone size={28} />
                ...
                <p>
                  Interface pensada para o trabalho de campo, com os dados do processo
                  sempre à mão.
                </p>
              </div>
              <div>
                ...
                <p>
                  Cada vistoria registrada em campo fica vinculada ao processo e ao
        ...
        <section id="contato" className="cta">
          <div className="container cta-inner">
            <div>
              <span className="tag">
                <Building2 size={14} /> Para prefeituras e consórcios
              </span>
              <h2>Leve a gestão ambiental do seu município para o digital.</h2>
              <p>
                Conheça o SIGAC e veja como centralizar licenças, fiscalizações, multas e
      ...
      <footer className="footer">
        <div className="container footer-grid">
          <div className="footer-brand">
            ...
            <p>
              Sistema Integrado de Gestão Ambiental Compartilhada para prefeituras e
              consórcios.
            </p>
          </div>
          <div>
          ...
          <div>
            <h4>Contato</h4>
            <a href="mailto:suporte@14tech.com.br">suporte@14tech.com.br</a>
          ...
          <div>
            ...
            <div className="footer-seal">
              <Landmark size={18} />
              <span>Integração com GeoBahia, MapBiomas e SIRGAS 2000</span>
            </div>
          </div>
        </div>
